...
function requestInitialData() {
    ...
    const touchCommand = `
        foreach v {
          ...
          system/net/type system/net/iface system/net/ip
...
/**
 * Update network status icon (wifi vs ethernet) for registry path
 */
...
/**
 * Open network status modal (interfaces + known-SSID AP scan)
 */
function openNetStatusModal() {
    ...
    if (!netStatusModal) {
        netStatusModal = new NetStatusModal({ connection, log });
    }
    netStatusModal.open();
}
