...
#define PICO_PERSIST_VERSION  13  /* v13: desc + pin labels + DI chord groups. v12: oled_en. v11:
                                   * transport_mode (dual). v10: ain_en. Fields are APPEND-ONLY: never
                                   * reorder/resize existing ones, so an older (shorter) blob loads
                                   * forward-compatibly with new fields defaulted (0 = off/none). */
