...
#
set colormatch [ess::create_protocol choice colormatch]

$colormatch add_method setup_trials { args } {
    # get variables we need from parent system associated choice system
    set vars { n_rep targ_radius targ_range ndists
	screen_halfx screen_halfy } 
    ...
    [my system] set_variable n_obs $n_obs
...
ess::create_variant choice colormatch redgreen setup_trials { color_choices redgreen }
ess::create_variant choice colormatch random   setup_trials { color_choices random }
ess::create_variant choice colormatch easy     setup_trials { n_rep 10 color_choices easy }
